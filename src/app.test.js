...
test('App test',async () => {
    ...
    const {getByText, findByText, getAllByDisplayValue} = render(<App />);
    await waitFor(() => {
...
const episodes = {
         ...
         "image":{
            ...
            "original":"https://i.picsum.photos/id/353/1800/2666.jpg?hmac=cDSf8lF4jMacHuoDL_fzIQKDjfhvPLC3vK83Nvcq4_k"
         },
