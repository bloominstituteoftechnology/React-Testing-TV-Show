...
const episodeData = [ 
    ...
    {
        id: 578665,
        url: 'http://www.tvmaze.com/episodes/578664/stranger-things-1x04-chapter-four-the-body',
        ...
        summary: '<p>Jim realizes that the government is covering something up about Will death and begins a personal investigation. Meanwhile, Nancy discovers that Jonathan has information about Barbara disappearance, while Mike and his friends smuggle Jane into the school so she can use the ham radio to contact Will.</p>',
        _links: {
          self: {
...
test('Returns and array with list of episodes', () => {
