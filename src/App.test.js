...
test('The App component renders', async () => {
  fetchShow.mockResolvedValueOnce(shows)

  await act( async () => { render(<App/>)})
})

test('The App allows a user to select a season', async () => {
  fetchShow.mockResolvedValueOnce(shows)
  ...
  // Diplays the season's episodes
  expect(screen.getAllByTestId('episodes'))
})